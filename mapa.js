  ...
  if (regionActiva === "argentina") {
    ...
    const filaArgentina = `
      <div class="pob-row pob-row-total">
        ...
        ${facturacionTotalArgentina > 0 ? `<div class="pob-facturacion-info">💰 Facturación estimada: USD ${facturacionTotalArgentina.toLocaleString('es-AR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</div>` : ""}
      </div>`;
